...
import link1234gamer.fnafmod.client.model.tile.ModelButton;
...
public class RenderLightButton extends TileEntitySpecialRenderer{
	
	private ModelButton modelButton;
	private ResourceLocation buttonTexture = new ResourceLocation("fnafmod:textures/blocks/lightButtonOff.png");

	public RenderLightButton() {
		this.modelButton = new ModelButton();
	}
...
//		this.modelCamera.cameraRotationPoint.rotateAngleY = ((TileEntityCamera) par1TileEntity).cameraRotation;
		...
		this.modelButton.render((Entity) null, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
