...
public class EntityMinirinaAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityMinirina theEntity;
    ...
    public EntityMinirinaAIMoveTowardsRestriction(EntityMinirina p_i2347_1_, double p_i2347_2_)
    {
