...
public class EntityPre_MangleAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityPre_Mangle theEntity;
    ...
    public EntityPre_MangleAIMoveTowardsRestriction(EntityPre_Mangle p_i2347_1_, double p_i2347_2_)
    {
