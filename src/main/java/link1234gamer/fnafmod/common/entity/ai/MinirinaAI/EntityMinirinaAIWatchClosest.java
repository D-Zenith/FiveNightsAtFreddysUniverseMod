...
public class EntityMinirinaAIWatchClosest extends EntityAIBase
{
    ...
    public EntityMinirinaAIWatchClosest(EntityLiving p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
    {
    ...
    public EntityMinirinaAIWatchClosest(EntityLiving p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
    ...
    {
    	if (((EntityMinirina)theWatcher).isAgressive())
        {
