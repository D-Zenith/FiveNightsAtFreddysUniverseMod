...
public class EntitySpringtrapAIBreakDoor extends EntityAIBase
{
    protected EntitySpringtrap entity;
    ...
    public EntitySpringtrapAIBreakDoor(EntitySpringtrap animatronic)
    {
