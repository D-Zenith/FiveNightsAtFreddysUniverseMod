...
public class EntityWBonnieAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityWBonnie theEntity;
    ...
    public EntityWBonnieAIMoveTowardsRestriction(EntityWBonnie p_i2347_1_, double p_i2347_2_)
    {
