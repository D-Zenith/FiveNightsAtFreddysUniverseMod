...
public abstract class EntityGoldenFreddyAITarget extends EntityAIBase
{
    protected EntityGoldenFreddy taskOwner;
    ...
    public EntityGoldenFreddyAITarget(EntityGoldenFreddy p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

	public EntityGoldenFreddyAITarget(EntityGoldenFreddy p_i1669_1_, boolean p_i1669_2_, boolean b) {

	}

	{
        EntityGoldenFreddy p_i1670_1_ = null;
		this.taskOwner = p_i1670_1_;
        boolean p_i1670_2_ = false;
		this.shouldCheckSight = p_i1670_2_;
        boolean p_i1670_3_ = false;
