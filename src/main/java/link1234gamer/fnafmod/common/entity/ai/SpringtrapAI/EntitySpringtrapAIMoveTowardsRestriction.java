...
public class EntitySpringtrapAIMoveTowardsRestriction extends EntityAIBase
{
    private EntitySpringtrap theEntity;
    ...
    public EntitySpringtrapAIMoveTowardsRestriction(EntitySpringtrap p_i2347_1_, double p_i2347_2_)
    {
