...
public class EntitySpringbonnieAIMoveTowardsRestriction extends EntityAIBase
{
    private EntitySpringbonnie theEntity;
    ...
    public EntitySpringbonnieAIMoveTowardsRestriction(EntitySpringbonnie p_i2347_1_, double p_i2347_2_)
    {
