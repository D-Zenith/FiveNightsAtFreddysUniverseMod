...
public class EntityFreddyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityFreddy theEntity;
    ...
    public EntityFreddyAIMoveTowardsRestriction(EntityFreddy p_i2347_1_, double p_i2347_2_)
    {
