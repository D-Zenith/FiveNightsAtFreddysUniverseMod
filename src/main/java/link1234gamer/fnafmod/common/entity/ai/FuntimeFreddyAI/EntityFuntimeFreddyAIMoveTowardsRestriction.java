...
public class EntityFuntimeFreddyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityFuntimeFreddy theEntity;
    ...
    public EntityFuntimeFreddyAIMoveTowardsRestriction(EntityFuntimeFreddy p_i2347_1_, double p_i2347_2_)
    {
