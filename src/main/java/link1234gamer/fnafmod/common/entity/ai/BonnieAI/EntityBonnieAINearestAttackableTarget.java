...
public class EntityBonnieAINearestAttackableTarget extends EntityBonnieAITarget
{
	private final Class targetClass;
	private final int targetChance;
	private final EntityBonnieAINearestAttackableTarget.Sorter theNearestAttackableTargetSorter;
	private final IEntitySelector targetEntitySelector;
	private EntityLivingBase targetEntity;

	public EntityBonnieAINearestAttackableTarget(EntityBonnie entity, Class p_i1663_2_, int p_i1663_3_, boolean p_i1663_4_)
	{
		this(entity, p_i1663_2_, p_i1663_3_, p_i1663_4_, false);
	}

	public EntityBonnieAINearestAttackableTarget(EntityBonnie p_i1664_1_, Class targetClass, int p_i1664_3_, boolean p_i1664_4_, boolean p_i1664_5_)
	{
