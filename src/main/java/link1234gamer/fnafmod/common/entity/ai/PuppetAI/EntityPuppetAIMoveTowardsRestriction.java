...
public class EntityPuppetAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityPuppet theEntity;
    ...
    public EntityPuppetAIMoveTowardsRestriction(EntityPuppet p_i2347_1_, double p_i2347_2_)
    {
