...
public class EntityFredbearAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityFredbear theEntity;
    ...
    public EntityFredbearAIMoveTowardsRestriction(EntityFredbear p_i2347_1_, double p_i2347_2_)
    {
