...
public class EntityGoldenFreddyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityGoldenFreddy theEntity;
    ...
    public EntityGoldenFreddyAIMoveTowardsRestriction(EntityGoldenFreddy p_i2347_1_, double p_i2347_2_)
    {
