...
public class EntityTFreddyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityToyFreddy theEntity;
    ...
    public EntityTFreddyAIMoveTowardsRestriction(EntityToyFreddy p_i2347_1_, double p_i2347_2_)
    {
