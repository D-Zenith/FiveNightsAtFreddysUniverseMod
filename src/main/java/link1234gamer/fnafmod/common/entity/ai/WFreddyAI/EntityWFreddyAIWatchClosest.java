...
public class EntityWFreddyAIWatchClosest extends EntityAIBase
{
	 private EntityLiving theWatcher;
	    ...
	    public EntityWFreddyAIWatchClosest(EntityLiving p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
	    {
	    ...
	    public EntityWFreddyAIWatchClosest(EntityLiving p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
	    {
	    ...
	    {
	    	if (((EntityWFreddy)theWatcher).isAgressive())
	        {
