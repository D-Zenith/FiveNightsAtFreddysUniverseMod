...
public class EntityFredbearAIWatchClosest extends EntityAIBase
{
    ...
    public EntityFredbearAIWatchClosest(EntityLiving p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
    {
    ...
    public EntityFredbearAIWatchClosest(EntityLiving p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
    ...
    {
    	if (((EntityFredbear)theWatcher).isAgressive())
        {
