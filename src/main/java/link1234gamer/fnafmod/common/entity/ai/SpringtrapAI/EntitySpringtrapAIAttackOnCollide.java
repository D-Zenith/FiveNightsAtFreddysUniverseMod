...
public class EntitySpringtrapAIAttackOnCollide extends EntityAIBase
{
    World worldObj;
    EntitySpringtrap attacker;
    int attackTick;
    ...
    public EntitySpringtrapAIAttackOnCollide(EntitySpringtrap p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
        this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
        this.classTarget = p_i1635_2_;
    }

    public EntitySpringtrapAIAttackOnCollide(EntitySpringtrap p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
