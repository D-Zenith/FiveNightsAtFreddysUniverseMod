...
public abstract class EntityPuppetAITarget extends EntityAIBase
{
    protected EntityPuppet taskOwner;
    ...
    public EntityPuppetAITarget(EntityPuppet p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityPuppetAITarget(EntityPuppet p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
