...
public abstract class EntitySpringbonnieAITarget extends EntityAIBase
{
    protected EntitySpringbonnie taskOwner;
    ...
    public EntitySpringbonnieAITarget(EntitySpringbonnie p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntitySpringbonnieAITarget(EntitySpringbonnie p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
