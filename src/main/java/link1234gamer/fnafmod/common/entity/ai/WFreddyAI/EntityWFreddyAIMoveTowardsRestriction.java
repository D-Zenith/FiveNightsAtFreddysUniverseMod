...
public class EntityWFreddyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityWFreddy theEntity;
    ...
    public EntityWFreddyAIMoveTowardsRestriction(EntityWFreddy p_i2347_1_, double p_i2347_2_)
    {
