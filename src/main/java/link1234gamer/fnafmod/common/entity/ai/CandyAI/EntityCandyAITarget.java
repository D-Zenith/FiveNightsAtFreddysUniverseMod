...
public abstract class EntityCandyAITarget extends EntityAIBase
{
    protected EntityCandy taskOwner;
    ...
    public EntityCandyAITarget(EntityCandy p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityCandyAITarget(EntityCandy p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
