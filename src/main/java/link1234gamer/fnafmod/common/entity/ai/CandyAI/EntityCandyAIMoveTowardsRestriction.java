...
public class EntityCandyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityCandy theEntity;
    ...
    public EntityCandyAIMoveTowardsRestriction(EntityCandy p_i2347_1_, double p_i2347_2_)
    {
