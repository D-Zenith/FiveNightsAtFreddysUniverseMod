...
public class EntityWFreddyAIAttackOnCollide extends EntityAIBase
{
    World worldObj;
    EntityWFreddy attacker;
    int attackTick;
    ...
    public EntityWFreddyAIAttackOnCollide(EntityWFreddy p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
        this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
        this.classTarget = p_i1635_2_;
    }

    public EntityWFreddyAIAttackOnCollide(EntityWFreddy p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
