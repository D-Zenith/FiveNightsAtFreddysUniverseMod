...
public class EntityPuppetAIStare extends EntityAIBase
{
    ...
    public EntityPuppetAIStare(EntityLiving entity, Class entityClass, float maxDist)
    {
    ...
    {
    	if (((EntityPuppet)theWatcher).isAgressive())
        {
