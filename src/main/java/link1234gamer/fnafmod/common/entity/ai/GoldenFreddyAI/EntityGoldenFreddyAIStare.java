...
public class EntityGoldenFreddyAIStare extends EntityAIBase
{
    ...
    public EntityGoldenFreddyAIStare(EntityLiving entity, Class entityClass, float maxDist)
    {
    ...
    {
    	if (((EntityGoldenFreddy)theWatcher).isAgressive())
        {
