...
public class EntityTBonnieAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityToyBonnie theEntity;
    ...
    public EntityTBonnieAIMoveTowardsRestriction(EntityToyBonnie p_i2347_1_, double p_i2347_2_)
    {
