...
public class EntityBonnieAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityBonnie theEntity;
    ...
    public EntityBonnieAIMoveTowardsRestriction(EntityBonnie p_i2347_1_, double p_i2347_2_)
    {
