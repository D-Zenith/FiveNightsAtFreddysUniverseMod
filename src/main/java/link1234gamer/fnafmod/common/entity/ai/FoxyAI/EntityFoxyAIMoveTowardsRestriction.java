...
public class EntityFoxyAIMoveTowardsRestriction extends EntityAIBase
{
    private EntityFoxy theEntity;
    ...
    public EntityFoxyAIMoveTowardsRestriction(EntityFoxy p_i2347_1_, double p_i2347_2_)
    {
