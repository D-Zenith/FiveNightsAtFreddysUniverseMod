...
public class EntitySpringbonnieAIBreakDoor extends EntityAIBase
{
    protected EntitySpringbonnie entity;
    ...
    public EntitySpringbonnieAIBreakDoor(EntitySpringbonnie animatronic)
    {
