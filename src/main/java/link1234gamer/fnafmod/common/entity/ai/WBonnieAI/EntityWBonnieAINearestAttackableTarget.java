package link1234gamer.fnafmod.common.entity.ai.WBonnieAI;
...
public class EntityWBonnieAINearestAttackableTarget extends EntityWBonnieAITarget
{
	private final Class targetClass;
	private final int targetChance;
	private final EntityWBonnieAINearestAttackableTarget.Sorter theNearestAttackableTargetSorter;
	private final IEntitySelector targetEntitySelector;
	private EntityLivingBase targetEntity;

	public EntityWBonnieAINearestAttackableTarget(EntityWBonnie entity, Class p_i1663_2_, int p_i1663_3_, boolean p_i1663_4_)
	{
		this(entity, p_i1663_2_, p_i1663_3_, p_i1663_4_, false);
	}

	public EntityWBonnieAINearestAttackableTarget(EntityWBonnie p_i1664_1_, Class targetClass, int p_i1664_3_, boolean p_i1664_4_, boolean p_i1664_5_)
	{
