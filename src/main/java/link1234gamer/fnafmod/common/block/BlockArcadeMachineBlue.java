...
public class BlockArcadeMachineBlue extends BlockContainer{

    public BlockArcadeMachineBlue()
    {
        super(Material.iron);
        float f = 0.0625F;
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, Block block)
    {
		...
		if (metadata % 8 >= 4)
		{
			if (world.getBlock(x, y - 1, z) != FNAF_Blocks.Arcade_Machine_Blue)
			{
	...
	{
		return new TileEntityArcadeMachineBlue();
	}
