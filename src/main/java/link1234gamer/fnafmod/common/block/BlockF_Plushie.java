...
public class BlockF_Plushie extends BlockContainer{

	public BlockF_Plushie()
    {
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int metadata)
	{
		...
		TileEntityF_Plushie tile = (TileEntityF_Plushie)world.getTileEntity(x, y, z);
	}
	
    public TileEntity createNewTileEntity(World world, int metadata)
	{
		return new TileEntityF_Plushie();
	}
